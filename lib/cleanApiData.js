...
// seven: data.hourly_forecast.slice(0, 7).reduce((array, hour) => {
//   array.push(
//     {
//       hour: data.hourly_forecast[hour].FCTTIME.civil,
//       icon: data.hourly_forecast[hour].icon_url,
//       tempF: data.hourly_forecast[hour].temp.english
//     }
//   );
//   return array;
// }, []),